              ...
              >
                ...
                <div className="space-y-0.5">
                  <Link
                    ...
                    className="flex items-center gap-3 p-2 rounded-xl bg-linear-to-r from-teal-50/90 via-emerald-50/70 to-slate-50/80 dark:from-teal-950/30 dark:via-emerald-950/20 dark:to-slate-950/30 hover:opacity-95 border border-teal-200/70 dark:border-teal-800/70 transition-all group mb-1 shadow-2xs"
                  >
                    <div className="w-7 h-7 rounded-lg bg-teal-500/20 text-teal-600 dark:text-teal-400 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-xs">
                      <BookOpen size={14} />
                    </div>
                    <div className="text-left">
                      <div className="text-xs font-bold text-stone-900 dark:text-zinc-100 flex items-center gap-1.5">
                        <span>Trilium Notes</span>
                        <span className="px-1.5 py-0.2 rounded-full bg-teal-600 text-white text-[8px] font-bold uppercase font-mono">
                          {language === 'en' ? 'Knowledge Base' : 'Basis Pengetahuan'}
                        </span>
                      </div>
                      <div className="text-[10px] text-stone-500 dark:text-zinc-400">
                        {language === 'en' ? 'Hierarchical Tree & Rich WYSIWYG' : 'Pohon Hierarkis & Editor Visual'}
                      </div>
                    </div>
                  </Link>
