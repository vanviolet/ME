          ...
          <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 text-xs">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-stone-200 dark:border-zinc-800 bg-stone-50 dark:bg-zinc-950 text-stone-900 dark:text-zinc-100 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-500/30 text-xs"
              />
            </div>
