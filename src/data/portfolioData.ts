...
export const profileData: ProfileInfo = {
  ...
  aboutEditorial: {
    en: [
      'I am a Fullstack Software Engineer based in Indonesia with practical experience delivering resilient, production-grade applications. Since 2022, I have served as a core Fullstack Developer at a prominent university, while simultaneously contributing as a remote engineer since 2023 and pursuing creative hobby software.',
      'My technical work spans the entire application spectrum—from architecting biometric facial recognition and university-wide academic ERPs handling thousands of concurrent users across Kubernetes clusters, to creating NoteLogic in 2024 as a personal hobby project solving music theory and ear training challenges.',
      'I treat software development as an engineering craft where simplicity, runtime performance, and maintainability supersede fleeting hype. Whether deploying containerized microservices to Kubernetes clusters or crafting fluid audio-synthesizing interfaces in React and TypeScript, I prioritize clarity and measurable impact.',
    ],
    id: [
      'Saya adalah seorang Fullstack Software Engineer yang berbasis di Indonesia dengan pengalaman nyata membangun aplikasi berskala produksi yang tangguh. Sejak tahun 2022, saya aktif sebagai Fullstack Developer di sebuah Universitas ternama, sekaligus merangkap kerja remote sejak 2023 dan mengembangkan karya software hobi kreatif.',
      'Karya teknis saya mencakup spektrum luas—dari merancang sistem absensi biometrik karyawan dan sistem kurikulum universitas yang melayani ribuan pengguna aktif di atas klaster Kubernetes, hingga membangun NoteLogic pada tahun 2024 sebagai proyek hobi pribadi yang memecahkan masalah pembelajaran musik.',
      'Bagi saya, rekayasa perangkat lunak adalah sebuah seni dan dedikasi di mana kesederhanaan, performa runtime, dan kemudahan perawatan kode menjadi prioritas utama. Baik saat mengorkestrasi microservices pada Kubernetes dan PostgreSQL, maupun membangun antarmuka web modern dengan React dan TypeScript.',
    ],
  },
  location: 'Indonesia',
...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    subtitle: {
      en: 'Most Widely Used Campus Learning Platform (Replacing Moodle)',
      id: 'Sistem Pembelajaran Digital Kampus Paling Banyak Digunakan',
    },
    description: {
      en: 'The university’s most widely used daily system, serving 15,000+ active students and faculty with high-speed reactive interfaces, automated exam anti-cheat engines, and gradebooks.',
      id: 'Sistem kampus yang paling banyak digunakan setiap hari, melayani 15.000+ mahasiswa dan dosen aktif dengan antarmuka reaktif berkecepatan tinggi, ujian online, dan sinkronisasi nilai otomatis.',
    },
    longDescription: {
      en: 'The university’s primary production application, serving over 15,000 students and hundreds of faculty members daily. Replaced legacy Moodle infrastructure with a modern reactive Next.js and NestJS architecture deployed on Kubernetes with Horizontal Pod Autoscaling (HPA) to comfortably absorb massive concurrent midterm and final exam surges.',
      id: 'Aplikasi produksi utama universitas dengan penggunaan harian tertinggi, melayani lebih dari 15.000 mahasiswa dan ratusan dosen. Menggantikan instalasi Moodle lama dengan arsitektur reaktif Next.js dan NestJS yang dideploy pada klaster Kubernetes dengan Horizontal Pod Autoscaling (HPA) agar kebal terhadap lonjakan ujian serentak.',
    },
    category: 'academic',
    year: '2023 — Present',
    isMostUsed: true,
    statusBadge: {
      en: 'Most Widely Used Platform',
      id: 'Paling Banyak Digunakan',
    },
  ...
  },
  {
    ...
    subtitle: {
      en: 'Latest Release (2024): Enterprise Facial & Geofence Verification',
      id: 'Aplikasi Terbaru (2024): Presensi Biometrik Wajah & Geofence',
    },
    description: {
      en: 'One of the newest enterprise applications (2024), featuring anti-spoofing facial recognition, high-precision GPS polygon verification, and shift scheduling across Kubernetes microservices.',
      id: 'Salah satu aplikasi sistem terbaru (2024) dengan verifikasi wajah anti-spoofing, validasi poligon GPS presisi tinggi, dan penjadwalan shift kerja yang berjalan di klaster Kubernetes.',
    },
    longDescription: {
      en: 'Recently deployed in 2024 as the university’s newest enterprise workforce management platform. Features computer vision liveness detection algorithms to eliminate photo/screen spoofing, dynamic 2D polygon campus geofencing, multi-shift calculations, and automated monthly payroll deductions.',
      id: 'Salah satu sistem terbaru yang diluncurkan pada tahun 2024 untuk pengelolaan presensi pegawai universitas. Dilengkapi algoritma liveness detection berbasis computer vision guna mencegah kecurangan foto/video, validasi geofence poligon akurat, dan integrasi rekapitulasi gaji otomatis.',
    },
    category: 'enterprise',
    year: '2024',
    isNewest: true,
    statusBadge: {
      en: 'Latest Release (2024)',
      id: 'Aplikasi Terbaru (2024)',
    },
    technologies: ['TypeScript', 'NestJS', 'PostgreSQL', 'Redis', 'Kubernetes', 'Docker', 'Computer Vision API'],
    highlights: {
      en: [
        'Newest production system (2024), completely eliminating fraudulent clock-in incidents with biometric liveness validation.',
      ...
      id: [
        'Sistem terbaru (2024) yang berhasil menekan kecurangan absensi hingga 0% berkat validasi liveness biometrik real-time.',
  ...
  },
  {
    ...
    subtitle: {
      en: 'Latest Release (2024): Outcome-Based Education (OBE) Syllabus Engine',
      id: 'Aplikasi Terbaru (2024): Sistem Kurikulum Terintegrasi & Akreditasi OBE',
    },
    description: {
      en: 'One of the newest core academic systems (2024), connecting faculty course outcomes (OBE/KKNI), department syllabi, prerequisite dependency graphs, and automated accreditation metrics.',
      id: 'Salah satu sistem terbaru (2024) yang menghubungkan Capaian Pembelajaran Lulusan (CPL/CPMK), pohon dependensi prasyarat mata kuliah, dan pelaporan akreditasi otomatis.',
    },
    longDescription: {
      en: 'Engineered and launched in 2024 as the university’s newest academic planning platform. Solves complex inter-departmental curriculum overlaps and Outcome-Based Education (OBE) compliance using directed acyclic graph (DAG) models, automated syllabus revision histories, and direct student study card (KRS) syncing.',
      id: 'Dibangun dan diluncurkan pada tahun 2024 sebagai salah satu sistem akademik terbaru. Mengatasi kerumitan pemetaan kurikulum OBE dengan model graf berarah (DAG), penyusunan RPS interaktif dosen, dan sinkronisasi langsung ke sistem KRS mahasiswa.',
    },
    category: 'academic',
    year: '2024',
    isNewest: true,
    ...
    highlights: {
      en: [
        'Newest academic infrastructure platform (2024) coordinating syllabus matrices across 30+ faculties and hundreds of lecturers.',
      ...
      id: [
        'Sistem kurikulum terbaru (2024) yang mengkoordinasikan matriks silabus dan RPS di 30+ program studi universitas.',
...
export const experienceData: Experience[] = [
  {
    ...
    achievements: {
      en: [
        'Spearheaded the development and campus-wide deployment of the custom University LMS (the institution’s most widely used platform), serving 15,000+ students and faculty members daily with 99.9% uptime.',
        'Architected high-availability Kubernetes infrastructure with Horizontal Pod Autoscaling (HPA) and Ingress controllers, seamlessly absorbing 12,000+ concurrent students during exam peaks without downtime.',
        'Engineered the Biometric Employee Attendance System (2024 release) incorporating computer vision facial verification and GPS geofencing, eliminating attendance fraud.',
        'Architected the Integrated Curriculum Management Platform (2024 release) to coordinate course syllabus matrices and Outcome-Based Education (OBE) accreditation across 30+ faculties.',
      ],
      id: [
        'Memimpin pengembangan dan implementasi LMS universitas mandiri (aplikasi kampus paling banyak digunakan) yang melayani 15.000+ mahasiswa dan dosen dengan uptime 99.9%.',
        'Mengelola infrastruktur kontainer universitas dengan Kubernetes, menerapkan Horizontal Pod Autoscaling (HPA) dan Ingress controller untuk menyerap 12.000+ mahasiswa saat lonjakan ujian serentak tanpa downtime.',
        'Merancang Sistem Absensi Biometrik (rilis 2024) dengan verifikasi wajah anti-spoofing dan validasi radius GPS untuk seluruh pegawai universitas.',
        'Membangun Sistem Kurikulum Terintegrasi (rilis 2024) untuk mengkoordinasikan silabus dan akreditasi kurikulum OBE di 30+ program studi.',
      ],
    },
  ...
  },
  {
    ...
    description: {
      en: 'Collaborating asynchronously with remote engineering teams since 2023 to build resilient SaaS products, distributed backend services, and high-load APIs.',
      id: 'Bekerja secara remote dalam tim rekayasa software terdistribusi sejak 2023 untuk merancang produk SaaS, backend microservices, dan automasi bisnis.',
    },
    achievements: {
      en: [
        'Built enterprise inventory and asset tracking platforms with real-time barcode telemetry, automated audit trails, and sub-second querying.',
        'Integrated AI capabilities (LLM workflows, RAG knowledge stores, and Vector Search) into business search and intelligence applications.',
        ...
        'Maintained clean code standards, automated testing pipelines, and Docker/Kubernetes deployment workflows.',
      ],
      id: [
        'Membangun aplikasi manajemen inventaris dan aset dengan integrasi scanner barcode, riwayat audit lengkap, dan kueri sub-detik.',
        'Mengintegrasikan kapabilitas AI (LLM, RAG, dan Vector Search) ke dalam mesin pencarian data internal perusahaan.',
        'Mengoptimasi kueri PostgreSQL dan arsitektur database relasional, meningkatkan throughput hingga 400%.',
        'Menjaga standar kualitas kode yang ketat, pipeline pengujian otomatis, dan workflow deployment Docker/Kubernetes.',
      ],
    },
  ...
  {
    id: 'exp-hobby',
    company: 'Personal Hobby Projects & Creative Software',
    companyType: {
      en: 'Personal Hobby & Music Learning Exploration',
      id: 'Proyek Hobi & Eksplorasi Musik Mandiri',
    },
    role: {
      en: 'Independent Creator (Personal Hobby Project)',
      id: 'Kreator Mandiri (Proyek Hobi Pribadi)',
    },
    period: '2024',
    location: {
      en: 'Indonesia / Personal Lab',
      id: 'Indonesia / Personal Lab',
    },
    description: {
      en: 'Built NoteLogic in 2024 purely as a personal hobby project for self-exploration and musical passion, solving the hurdles of music theory, chord discovery, and interactive score editing.',
      id: 'Membangun NoteLogic pada tahun 2024 sebagai proyek hobi pribadi untuk diri sendiri dan kecintaan pada musik, memecahkan kesulitan belajar teori musik, pencarian chord, dan visualisasi partitur.',
    },
    achievements: {
      en: [
        'Engineered NoteLogic (van-theory.vercel.app) purely as a personal hobby project in 2024, solving music learning challenges with 954+ chord visualizations, interactive fretboards, and piano voicings.',
        'Implemented zero-latency sound synthesis using Web Audio API oscillators, completely eliminating the need for heavyweight audio sample downloads.',
        'Created an in-browser Tab Studio score editor with interactive measure grids, tempo controls, and audio playback.',
        'Engineered modular commercial web utilities including Hotel Room Management, Boarding House Rental SaaS, and Secure Digital Voting.',
      ],
      id: [
        'Membangun NoteLogic (van-theory.vercel.app) murni sebagai proyek hobi pribadi di tahun 2024, memecahkan masalah pembelajaran musik dengan 954+ chord, fretboard gitar, dan tuts piano.',
        'Mengimplementasikan mesin sintesis suara tanpa latensi menggunakan osilator Web Audio API, menghilangkan kebutuhan download sampel audio berat.',
        'Menciptakan editor partitur Tab Studio in-browser dengan grid birama, kontrol tempo, dan pemutaran audio real-time.',
        'Merancang solusi manajemen komersial seperti Sistem Kamar Hotel, Aplikasi Kos-kosan, dan E-Voting aman.',
      ],
    },
    technologies: ['React', 'TypeScript', 'Web Audio API', 'Tailwind CSS', 'Vite', 'Fretboard Math Engine'],
  },
];
